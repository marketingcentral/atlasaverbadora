// Canonical state machines. See specs/domain/state-machines.md.

export type EntityKind = "proposta" | "contrato" | "portabilidade" | "reserva";

type Transition = Readonly<{ event: string; from: string; to: string }>;
...
export function asJson(entity: EntityKind) {
  return MAP[entity];
}
