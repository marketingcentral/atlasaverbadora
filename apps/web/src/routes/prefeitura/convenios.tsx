      ...
      <Card>
        <div style={{ display: "flex", alignItems: "start", justifyContent: "space-between", gap: 16, flexWrap: "wrap" }}>
          <div>
            ...
            <p style={{ color: "var(--text-muted)", fontSize: 13, margin: "4px 0 0", maxWidth: 520 }}>
              Definidas pela averbadora. O banco precisa cumprir pra averbar contratos desta prefeitura.
            </p>
          </div>
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            <Pill variant={exigeCcb ? "emdia" : "pendente"}>Anexo da CCB: {exigeCcb ? "exigido" : "não exigido"}</Pill>
            <Pill variant={exige2fa ? "emdia" : "pendente"}>Verificação 2FA: {exige2fa ? "exigida" : "não exigida"}</Pill>
          </div>
        </div>
      </Card>
