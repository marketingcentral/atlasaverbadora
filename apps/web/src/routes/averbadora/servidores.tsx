...
export function AdminServidores() {
  ...
  const columns: Column<AdminServidor>[] = [
    { key: "nome", header: "Nome", wrap: true },
    { key: "matricula", header: "Matrícula", mono: true },
    { key: "cpf", header: "CPF", mono: true, render: (s) => fmtCpf(s.cpf) },
    { key: "cargo", header: "Cargo", wrap: true, render: (s) => s.cargo || <span style={{ color: "var(--text-dim)" }}>—</span> },
    { key: "origem", header: "Origem", wrap: true },
    { key: "vinculo", header: "Vínculo", wrap: true },
    { key: "situacaoFuncional", header: "Situação funcional", wrap: true, render: (s) => s.situacaoFuncional || <span style={{ color: "var(--text-dim)" }}>—</span> },
    ...
    { key: "email", header: "E-mail", wrap: true, render: (s) => s.email || <span style={{ color: "var(--text-dim)" }}>—</span> },
    ...
    { key: "endereco", header: "Endereço", wrap: true, render: (s) => s.endereco || <span style={{ color: "var(--text-dim)" }}>—</span> },
